...
namespace DkTools.GlobalData
{
	internal class AppRepo
	{
		...
		public void UpdateFile(CodeModel.CodeModel model, FFScanMode scanMode)
		{
			lock (this)
			{
		...
		private List<int> CreateFileDataFromModel(CodeModel.CodeModel model, FFScanMode scanMode)
		{
		...
		private List<Reference> GetReferencesFromModel(CodeModel.CodeModel model)
		{
		...
		private List<ExtractStatement> GetPermanentExtractsFromModel(CodeModel.CodeModel model)
		{
