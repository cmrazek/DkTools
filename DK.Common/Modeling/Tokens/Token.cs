...
namespace DK.Modeling.Tokens
{
	...
	public abstract class Token
	{
		...
		private ProbeClassifierType _classifierType;
		private FilePosition _filePos;

		public bool HasBreakParent => _scope.BreakOwner != null;
		public bool HasContinueParent => _scope.ContinueOwner != null;
		...
		internal Token(Scope scope)
		{
			_scope = scope;
		}

		internal Token(Scope scope, CodeSpan span)
		{
			_scope = scope;
			_span = span;
		}
		...
		/// </summary>
		internal virtual void CommitToParentToken(GroupToken parent)
		{
		...
		internal CodeFile File
		{
			get { return _scope.File; }
		}

		internal CodeParser Code
		{
		...
		public IEnumerable<Token> FindDownward(CodeSpan span)
		{
		...
		public ProbeClassifierType ClassifierType
		{
