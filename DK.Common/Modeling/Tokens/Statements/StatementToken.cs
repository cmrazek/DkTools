...
{
	public class StatementToken : GroupToken
	{
		...
		internal static bool IsStatementBreakingWord(Scope scope, string word)
		{
		...
		internal static StatementToken TryParse(Scope scope, StatementParseCallback callback = null)
		{
			var code = scope.Code;
