...
{
	public class CreateStatement : GroupToken
	{
		...
		internal static CreateStatement ParseCreate(Scope scope, KeywordToken createToken)
		{
			scope = scope.Clone();
		...
		internal static CreateStatement ParseAlter(Scope scope, KeywordToken alterToken)
		{
			scope = scope.Clone();
			scope.Hint |= ScopeHint.SuppressStatementStarts | ScopeHint.SuppressFunctionDefinition | ScopeHint.SuppressFunctionCall | ScopeHint.SuppressLogic;
