...
namespace DK.Code
{
    public class CodeParser
    {
        ...
        public bool ReadExactWholeWord(params string[] expectingList)
        {
        ...
        public bool ReadExact(params string[] items)
        {
            foreach (var item in items)
            {
                if (ReadExact(item)) return true;
            }
        ...
        public bool ReadNumber()
        {
            ...
            while (_pos < _length)
            {
                ...
                else if (ch == '-' && _tokenText.Length == 0)
                {
                    _tokenText.Append('-');
                    _pos++;
                }
        ...
        public bool PeekExactWholeWord(params string[] expectingList)
        {
            var pos = _pos;
