...
namespace DK.CodeAnalysis
{
    public struct CAErrorTask
    {
        ...
        public bool MainFile { get; private set; }

        public CAErrorTask(CAError errorCode, string message, string filePath, CodeSpan span, int lineNumber, int linePosition,
            string invokingFilePath, bool mainFile)
        {
            ErrorCode = errorCode;
            Message = message;
            FilePath = filePath;
